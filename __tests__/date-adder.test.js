...
describe('add to date function', () =>{
  ...
  it('adds months to a date', () => { expect(add(new Date('2020-01-01'), '30M')).toEqual(new Date('2020-07-29T00:00:00.000Z')); });
  it('adds years to a date', () => { expect(add(new Date('2020-01-01'), '30y')).toEqual(new Date('2020-01-01T00:00:30.000Z')); });
});
